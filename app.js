...
function openAssetTypePanel(r=true){if(r){el('s-assettype-id').value='';el('s-assettype-name').value='';el('s-assettype-builtin').value='';el('s-assettype-panel-title').textContent='銘柄種別を追加';}_panelOpen('s-assettype-panel');}
